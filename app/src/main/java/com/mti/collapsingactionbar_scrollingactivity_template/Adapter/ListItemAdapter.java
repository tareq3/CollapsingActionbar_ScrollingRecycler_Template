/*
 * Created by Tareq Islam on 8/10/18 2:12 AM
 *
 *  Last modified 8/10/18 1:54 AM
 */
...
package com.mti.collapsingactionbar_scrollingactivity_template.Adapter;
...
import com.mti.collapsingactionbar_scrollingactivity_template.MainActivity;
import com.mti.collapsingactionbar_scrollingactivity_template.R;
...
public class ListItemAdapter extends RecyclerView.Adapter<ListItemViewHolder> implements Filterable {
    ...
    @NonNull
       ...
       public ListItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.activity_main_col_card,parent,false);
...
//Todo: Load Data
           ...
           holder.setItemClickListener(new ItemClickListener() {
               ...
               public void onClick(View view, int position, boolean isLongClick) {
                       ...
                       //Todo: single click Actions Here
